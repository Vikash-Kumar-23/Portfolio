...
const expCards = [
  ...
  },
  {
    ...
    date: "March 2025",
    responsibilities: [
      "Backend & Database: Node.js and Express.js with MongoDB for scalable data storage and APIs.",
      "Frontend & UI: EJS templates with Tailwind CSS for a responsive, Instagram-like interface.",
      "Auth & Media: Passport.js for authentication and Multer for image uploads.",
    ],
  },
  {
    review: "",
    ...
    date: "January 2026",
    responsibilities: [
      "Frontend/UI: Python-based Streamlit app ( app.py ) for an interactive web interface.",
      "AI & Processing: Google Gemini LLM for document summarization and risk/liability analysis.",
      "Utilities & Data Handling: dotenv for API key management, with custom modules for PDF/DOCX/TXT ingestion, text cleaning, chunking, and prompt templates.",
    ],
  },
];
